...
**Goal**: Create a comprehensive README.md for the current project.

**Steps**:

1. Scan the entire codebase to understand the project's purpose and dependencies.

2. Make sure to create documents for details which a junior software engineer would require, such as comprehension notes, study guide, and industry standard best practices to prepare engineer for the workforce.

3. Create or Update README.md with the following sections:
